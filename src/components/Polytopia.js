        ...
        <div className=" pt-5 pb-5">
            <div className="grid grid-cols-12 gap-4">
                ...
                {/* "col-span-12 lg:col-span-4" */}
                    <h1 className="text-primary-content text-3xl justify-center font-bold ">Polytopia</h1>
                    <h2 className="text-primary-content text-2xl justify-center">Battle Calculator</h2>
